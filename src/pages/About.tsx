  ...
  const handleDownload = () => {
    ...
    const timer = setInterval(() => {
      ...
      if (time <= 0) {
        ...
        const imageUrl = `${window.location.origin}/assets/anandhakumar.png`;
...
<head>
    ...
    <title>Anandhakumar Resume</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="resume-wrapper">
            <!-- Header -->
            <div class="header">
                <img src="${imageUrl}" alt="Anandhakumar M" class="profile-photo">
                <div class="header-content">
                    <h1>Anandhakumar M</h1>
                    <p class="title">Frontend Developer | Junior Software Developer</p>
                    <div class="contact-info">
                        <div class="contact-item">
                            <span class="contact-icon">🏠︎</span>
                            <span id="colorid">Dharmapuri, TamilNadu, India</span>
                        </div>
                        <div class="contact-item">
                            <span class="contact-icon">✉︎</span>
                            <a href="">anandhakumar994384@gmail.com</a>
                        </div>
                        <div class="contact-item">
                        ...
                        <div class="contact-item">
                            <span class="contact-icon">⛆</span>
                            <a href="" target="_blank">Anandhakumar M</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="content">
                ...
                <section class="section">
                    ...
                    <div class="summary-text">
                        Aspiring Junior Software Developer with
                       knowledge of HTML, CSS, JavaScript,
                     Java, and Python. Strong problem-solving
                     skills and a passion for web development
                      and software programming. Quick
                      learner, adaptable, and eager to
                      contribute to a professional software
                      development team while continuously
                    ...
                    <div class="skills-grid">
                        <div class="skill-category">
                            ...
                            <div class="skill-tags">
                                ...
                                <span class="skill-tag">My Sql</span>
                            </div>
                        </div>
                        <div class="skill-category">
                ...
                <section class="section">
                    ...
                    <div class="education-item">
                        <h3>High Secondary Education (Class 12 - GBHSL)</h3>
                        <p>I Am Recently Completed Bachelor Degree In BSC-Computer Science</p>
                    </div>
                </section>
                ...
                <section class="section">
                    ...
                    <div class="objective-box">
                        obtain a meaningful and challenging position that
                      enables me to provide my innovative skills and allows
                      for upgrading my knowledge for my career progress. 
                    </div>
                </section>
                ...
                <section class="section">
                    ...
                    <div class="skills-grid">
                        <div class="skill-category">
                            ...
                            <div class="skill-tags">
                                <span class="skill-tag">Cybersecurit</span>
                                <span class="skill-tag">Data analasis</span>
        ...
        a.href = url;
        a.download = "Anandhakumar_Resume.html";
            ...
            >
              ...
              <p>
                I have knowledge of HTML, CSS, JavaScript,
                 React.js, Python, Java, and MySQL.
                  I enjoy building responsive websites, learning new technologies,
                   and solving programming problems.
              </p>

              <p>
                I am a quick learner, a good team player, and always
                 eager to improve my technical and communication skills.
              </p>

              <p>
                My goal is to start my career as a software developer and contribute
                 to the success of an organization while continuously growing as a professional.
              </p>
              ...
              <p>
               To obtain a meaningful and challenging position that
                enables me to provide my innovative skills and allows
                for upgrading my knowledge for my career progress
              </p>

              <p>
                Quick learner, adaptable, and eager to
                contribute to a professional software development team while continuously
               enhancing technical skills.
              </p>
            </div>
          </div>
